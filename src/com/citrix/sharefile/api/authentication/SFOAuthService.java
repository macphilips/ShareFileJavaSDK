...
public class SFOAuthService implements ISFOAuthService {
     ...
     *
     * @param subDomain       - hostname like "yourcompanyname"
     * @param apiControlPlane - hostname like "sharefile.com"
     * @param clientId        - your apiClient id
     * @param clientSecret    - your apiClient secret
     ...
     * @param subDomain       - hostname like "yourcompanyname"
     * @param apiControlPlane - hostname like "sharefile.com"
     * @param samlAssertion   - Base64 URL encoded SAML assertion.
     * @return an OAuth2Token instance
     * @throws SFJsonException
     */
